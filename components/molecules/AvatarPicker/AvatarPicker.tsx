      ...
      >
        {shown.map((seed, i) => {
          ...
          return (
            ...
            >
              {/* No hat, deliberately. This row asks one question — which
                  face — and answering it in a costume puts ten near-identical
                  hats where ten distinct faces are the whole point. */}
              <Avatar
                name={seedLabel(seed)}
